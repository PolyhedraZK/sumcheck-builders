  ...
  return (
    <div className="content">
      ...
      <ul className="talks-list">
        {[
          {
            speaker: "Simon Lau from Polyhedra",
          ...
          {
            speaker: "Vishruti (cryptography at %)",
          ...
          {
            speaker: "Tiancheng from Polyhdera team",
          ...
          {
            speaker: "Zhenfei from the Polyhedra team",
